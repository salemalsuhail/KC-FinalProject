...
public final class IdtamweenkBinding implements ViewBinding {
  @NonNull
  ...
  private IdtamweenkBinding(@NonNull ConstraintLayout rootView, @NonNull Button button,
  ...
  @NonNull
  public static IdtamweenkBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static IdtamweenkBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.idtamweenk, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static IdtamweenkBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new IdtamweenkBinding((ConstraintLayout) rootView, button, editTextTextPersonName,
          editTextTextPersonName2, imageView, textView);
    }
